<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="菜品编号" prop="caipinbianhao">
					<el-input v-model="ruleForm.caipinbianhao" placeholder="菜品编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.caipinbianhao" label="菜品编号" prop="caipinbianhao">
					<el-input v-model="ruleForm.caipinbianhao" placeholder="菜品编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="菜品标签" prop="caipinbiaoqian">
					<el-select :disabled="ro.caipinbiaoqian" v-model="ruleForm.caipinbiaoqian" placeholder="请选择菜品标签" >
						<el-option
							v-for="(item,index) in caipinbiaoqianOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="菜品标签" prop="caipinbiaoqian">
					<el-input v-model="ruleForm.caipinbiaoqian"
						placeholder="菜品标签" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="口味" prop="kouwei">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="配菜" prop="peicai">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="配菜"
					  v-model="ruleForm.peicai" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.peicai" label="配菜" prop="peicai">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.peicai}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="营养成分" prop="yingyangchengfen">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.yingyangchengfen" label="营养成分" prop="yingyangchengfen">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yingyangchengfen}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.caipinxiangqing" label="菜品详情" prop="caipinxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.caipinxiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='caipinbiaoqian'){
							this.ruleForm.caipinbiaoqian = obj[o];
							this.ro.caipinbiaoqian = true;
							continue;
						}
						if(o=='tupian'){
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.caipinbiaoqianOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
            this.kouweiOptions = "清淡,微辣,酸辣,麻辣".split(',')
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.caipinxiangqing = this.ruleForm.caipinxiangqing.replace(reg,'../../../springboot2axo8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
