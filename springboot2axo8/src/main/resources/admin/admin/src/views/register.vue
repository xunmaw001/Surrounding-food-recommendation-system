<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","width":"100%","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220722/898b4b26c0464f8caa1cd58e5eafe0c9.png) no-repeat center top / 100% 100%","justifyContent":"center","display":"flex"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":" 8px solid #FFFFFF","padding":"10px 20px","margin":"0","borderRadius":"0 0 50px 50px","top":"0","background":"rgba(228, 239, 254, 0.8000)","width":"450px","position":"absolute","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px 20px","margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","height":"auto"}' class="title">基于微信小程序的周边美食推荐系统注册</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"20px auto 15px","color":"#fff","display":"block","outline":"none","borderRadius":"8px","background":"rgba(126, 169, 228, 1)","width":"80%","fontSize":"16px","height":"40px"}' type="button" class="r-btn" @click="login()">注册</button>
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20220722/898b4b26c0464f8caa1cd58e5eafe0c9.png) no-repeat center top / 100% 100%;
