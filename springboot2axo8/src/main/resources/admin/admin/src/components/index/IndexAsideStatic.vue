<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"width":"160px","padding":"0","listStyle":"none","margin":"20px 10px 30px","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","width":"130px","margin":"0 0 0 -10px","overflow":"hidden","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  border-radius: 10px;
				  				  padding: 0 10px;
				  				  box-shadow: -20px 0px 0px 0px #deecfb;
				  				  color: #333;
				  				  white-space: nowrap;
