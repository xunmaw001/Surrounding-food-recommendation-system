	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0px 0px 208rpx 0px","position":"relative","background":"url(http://codegen.caihongy.cn/20221018/6b04e4b2331b4f3d85b1103feff37414.jpg)","height":"auto"}'>
			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				<scroll-view scroll-x="true" class="category-one" :style='{"width":"100%","whiteSpace":"nowrap","background":"#fff","display":"flex","height":"auto"}'>
			...
			<view class="list" :style='{"width":"100%","padding":"24rpx","margin":"0px 0px 64rpx 0px","background":"none","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="listm flex flex-between" :style='{"padding":"0px","margin":"0 0 40rpx 0","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}' v-for="(product,index) in list" :key="index">
				  <image :style='{"width":"240rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"16rpx","display":"block","height":"240rpx"}' mode="aspectFill" class="listmpic" v-if="preHttp(product.tupian)" :src="product.tupian.split(',')[0]"></image>
				  <image :style='{"width":"240rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"16rpx","display":"block","height":"240rpx"}' mode="aspectFill" class="listmpic" v-else :src="product.tupian?baseUrl+product.tupian.split(',')[0]:''"></image>
				  ...
				  <view class="listmr" :style='{"minHeight":"192rpx","padding":"12rpx 0","boxShadow":"6rpx 6rpx 6rpx rgba(180,180,180,.3),inset 0px 0px 112rpx 0px #d7f6f2","margin":"12rpx 0px 12rpx 0","borderRadius":"16rpx","background":"#fff","flex":"1","width":"100%","height":"auto"}'>
					<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx"}'>{{product.caipinmingcheng}}</view>
					<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx"}'>{{product.caipinfenlei}}</view>
					<view class="colb f24 lh35" :style='{"padding":"0 24rpx","margin":"0","color":"red","textAlign":"left","borderRadius":"16rpx 16rpx 0 0","top":"192rpx","left":"80rpx","background":"rgba(255,255,255,.8)","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","position":"absolute","zIndex":"11"}'>￥{{product.price}}</view>
				  </view>
					...
					<view :style='{"padding":"0px","margin":"20rpx 0 0","textAlign":"right","display":"flex","width":"100%","float":"right","justifyContent":"flex-end","height":"auto"}'>
						<view :style='{"cursor":"pointer","margin":"0px 16rpx 0 0","display":"flex"}' v-if="(userid && isAuth('caipinxinxi','修改')) || (!userid && isAuthFront('caipinxinxi','修改'))" @click.stop="onUpdateTap(product.id)">
						...
						<view :style='{"cursor":"pointer","margin":"0px 16rpx 0 0","display":"flex"}' v-if="(userid && isAuth('caipinxinxi','删除')) || (!userid && isAuthFront('caipinxinxi','删除'))" @click.stop="onDeleteTap(product.id)">
