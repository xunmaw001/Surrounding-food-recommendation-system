	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0px 0px 208rpx 0px","position":"relative","background":"url(http://codegen.caihongy.cn/20221018/6b04e4b2331b4f3d85b1103feff37414.jpg)","height":"auto"}'>
			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				...
				<!-- 样式6 -->
				<view class="news-box6" :style='{"width":"100%","padding":"24rpx","margin":"0","background":"none","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"8rpx 24rpx 8rpx 80rpx","boxShadow":"0 2rpx 12rpx rgba(180,180,180,.3)","margin":"0 0 20rpx","borderRadius":"16rpx","background":"#fff","width":"100%","position":"relative","height":"auto"}'>
					  <view :style='{"padding":"0","margin":"-28rpx 0 0 16rpx","borderColor":"#1eaa99","color":"#1eaa99","textAlign":"center","borderRadius":"20% 40%","top":"44rpx","left":"0","borderWidth":"2rpx","width":"56rpx","lineHeight":"56rpx","fontSize":"28rpx","position":"absolute","borderStyle":"solid","height":"56rpx"}' class="num">
					  ...
					  <view class="item-list-body" :style='{"width":"100%","margin":"0","height":"auto"}'>
						<view :style='{"width":"100%","padding":"4rpx 20rpx","lineHeight":"1.4","fontSize":"28rpx","color":"#333"}' class="title ">{{product.title}}</view>
						<view :style='{"padding":"4rpx 20rpx","overflow":"hidden","color":"#666","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","height":"96rpx"}' class="desc ">{{product.introduction}}</view>
					  </view>
					</view>
				</view>
